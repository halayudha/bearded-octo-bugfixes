...
---mapping table stored at SERVER PEER 5---
create table Exported_DB.MAPPING_TABLE (local_term text, global_term text, table_name text, column_name text, user_name text)
insert into Exported_DB.MAPPING_TABLE values ('backache','backache','visit','reason','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('cough','cough','visit','reason','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('sore throat','sore throat','visit','reason','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('fever','fever','visit','reason','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('stomach problem','stomach problem','visit','reason','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('heart problem','heart problem','visit','reason','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('respiratory problem','respiratory problem','visit','reason','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('cephalalgia','headache','visit','reason','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('MCH','mean corpuscular hemoglobin','medical_test','test_name','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('heart rate','heart rate','medical_test','test_name','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('RDW','red cell distribution width','medical_test','test_name','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('ABG','arterial blood gas','medical_test','test_name','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('TIBC','total iron binding capacity','medical_test','test_name','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('MCV','mean corpuscular volume','medical_test','test_name','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('MCHC','MCHC','medical_test','test_name','PH5000001')
insert into Exported_DB.MAPPING_TABLE values ('swine flu','swine influenza','medical_test','test_name','PH5000001')
