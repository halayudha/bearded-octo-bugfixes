...
insert into Exported_DB.MAPPING_TABLE values ('TIBC','total iron binding capacity','medical_test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('MCV','mean corpuscular volume','medical_test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('MCH','mean corpuscular hemoglobin','medical_test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('heart rate','heart rate','medical_test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('RDW','red cell distribution width','medical_test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('MCHC','MCHC','medical_test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('ABG','arterial blood gas','medical_test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('H1N1','swine influenza','medical_test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('dengue','dengue','medical_test','test_name','PH1000001')
