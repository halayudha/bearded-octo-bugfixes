...
--insert into Metabestpeer.report values ('all H1N1 patient information', 'authority', 'select patient.patient_id, patient.first_name, patient.age, medical_test.test_name, medical_test.value, medical_test.test_date from patient, medical_test  where medical_test.test_name=\'H1N1\' and medical_test.value=\'positive\' and medical_test.test_date>=\'2009-07-01\' and medical_test.test_date<=\'2009-07-30\' and patient.patient_id=medical_test.patient_id','no_param','Display information of all H1N1 patients', 'Analytical query', 'system built-in')
insert into Metabestpeer.report values ('H1N1 statistics', 'authority', 'select patient.patient_id, patient.first_name, patient.age, patient.address, medical_test.test_name, medical_test.value, medical_test.test_date from patient, medical_test  where medical_test.test_name=\'H1N1\' and medical_test.value=\'positive\' and medical_test.test_date>=$from_date$ and medical_test.test_date<=$to_date$ and patient.patient_id=medical_test.patient_id','-1|from_date:-1|to_date:','Display information of H1N1 patients in a period input by user', 'Analytical query', 'system built-in')
...
---mapping table stored at SERVER PEER 2---
create table Exported_DB.MAPPING_TABLE (local_term text, global_term text, table_name text, column_name text, user_name text)
insert into Exported_DB.MAPPING_TABLE values ('cephalea','headache','visit','reason','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('stomach problem','stomach problem','visit','reason','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('sore throat','sore throat','visit','reason','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('fever','fever','visit','reason','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('heart problem','heart problem','visit','reason','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('backache','backache','visit','reason','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('cough','cough','visit','reason','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('respiratory problem','respiratory problem','visit','reason','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('MCHC','MCHC','medical_test','test_name','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('heart rate','heart rate','medical_test','test_name','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('mean corpuscular hemoglobin','mean corpuscular hemoglobin','medical_test','test_name','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('mean corpuscular volume','mean corpuscular volume','medical_test','test_name','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('red cell distribution width','red cell distribution width','medical_test','test_name','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('arterial blood gas','arterial blood gas','medical_test','test_name','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('total iron binding capacity','total iron binding capacity','medical_test','test_name','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('swine flu','swine influenza','medical_test','test_name','PH2000001')
insert into Exported_DB.MAPPING_TABLE values ('dengue','dengue','medical_test','test_name','PH2000001')
