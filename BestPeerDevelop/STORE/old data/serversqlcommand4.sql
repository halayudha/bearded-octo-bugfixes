...
---mapping table stored at SERVER PEER 4---
create table Exported_DB.MAPPING_TABLE (local_term text, global_term text, table_name text, column_name text, user_name text)
insert into Exported_DB.MAPPING_TABLE values ('heart problem','heart problem','visit','reason','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('cough','cough','visit','reason','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('fever','fever','visit','reason','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('sore throat','sore throat','visit','reason','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('backache','backache','visit','reason','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('stomach problem','stomach problem','visit','reason','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('headache','headache','visit','reason','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('respiratory problem','respiratory problem','visit','reason','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('arterial blood gas','arterial blood gas','medical_test','test_name','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('total iron binding capacity','total iron binding capacity','medical_test','test_name','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('red cell distribution width','red cell distribution width','medical_test','test_name','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('heart rate','heart rate','medical_test','test_name','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('mean corpuscular volume','mean corpuscular volume','medical_test','test_name','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('mean corpuscular hemoglobin','mean corpuscular hemoglobin','medical_test','test_name','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('MCHC','MCHC','medical_test','test_name','PH4000001')
insert into Exported_DB.MAPPING_TABLE values ('H1N1','swine influenza','medical_test','test_name','PH4000001')
