...
INSERT INTO BestPeerSchemaMapping.Matches VALUES ('localdb','test','1','patient_id','1','BestPeerServerGS','test','1','patient_id','1')
INSERT INTO BestPeerSchemaMapping.Matches VALUES ('localdb','test','1','test_name','1','BestPeerServerGS','test','1','test_name','1')
INSERT INTO BestPeerSchemaMapping.Matches VALUES ('localdb','test','1','value','1','BestPeerServerGS','test','1','value','1')
INSERT INTO BestPeerSchemaMapping.Matches VALUES ('localdb','test','1','test_date','1','BestPeerServerGS','test','1','test_date','1')
...
create table Metabestpeer.REPORT (report_name text, role_name text, sql_string text, param text, description text)
insert into Metabestpeer.report values ('patient information','patient','select * from patient', 'no_param', 'Display information of the patient')
insert into Metabestpeer.report values ('test list','patient','select * from test', 'no_param', 'Display the test list of the patient')
insert into Metabestpeer.report values ('medication history','patient','select * from medication', 'no_param', 'Display the medication history of the patient')
insert into Metabestpeer.report values ('visit history','patient','select * from visit', 'no_param', 'Display the visit history of the patient')
insert into Metabestpeer.report values ('patient list','physician','select patient.patient_id, patient.first_name, patient.last_name, patient.date_of_birth, patient.age, patient.gender, patient.nationality from patient, treat where patient.patient_id = treat.patient_id', 'no_param', 'Display the list of patients under his treatment')
insert into Metabestpeer.report values ('patient allergy','physician','select patient.patient_id, allergy.allergy_name from patient, allergy  where patient.patient_id=$patient_id$ and patient.patient_id=allergy.patient_id', '-1|patient_id:', 'Display the allergies of a patient')
insert into Metabestpeer.report values ('medication history','physician','select medication.patient_id, medication.medicine, medication.dosage, visit.location, medication.start_date, medication.end_date, visit.reason from visit, medication  where medication.patient_id=$patient_id$ and visit.patient_id=medication.patient_id and visit.visit_date=medication.start_date','-1|patient_id:', 'Display the medication history of a patient')
insert into Metabestpeer.report values ('patient list','authority','select * from patient', 'no_param', 'Display the information of all patients')
insert into Metabestpeer.report values ('test list during period','authority','select test.patient_id, test.test_name, test.value, test.test_date from test  where test.test_name=$test_name$ and test.test_date>=$from_date$ and test.test_date<=$to_date$', '-1|test_name:-1|from_date:-1|to_date:', 'Display the list of tests taken during a period.')
insert into Metabestpeer.report values ('analysis by test name', 'authority', 'select count(test.patient_id), test.test_name from test  group by test.test_name','no_param', 'Show the number of tests taken group by test name')
insert into Metabestpeer.report values ('analysis by allergy name', 'authority', 'select count(allergy.patient_id), allergy.allergy_name from allergy  group by allergy.allergy_name','no_param', 'Show the number of patients got allergies of each type')
insert into Metabestpeer.report values ('all H1N1 patient information', 'authority', 'select patient.patient_id, patient.first_name, patient.age, test.test_name, test.value, test.test_date from patient, test  where test.test_name=\'H1N1\' and test.value=\'positive\' and test.test_date>=\'2009-07-01\' and test.test_date<=\'2009-07-30\' and patient.patient_id=test.patient_id','no_param','Display information of all H1N1 patients')
insert into Metabestpeer.report values ('H1N1 patient during a period', 'authority', 'select patient.patient_id, patient.first_name, patient.age, test.test_name, test.value, test.test_date from patient, test  where test.test_name=\'H1N1\' and test.value=\'positive\' and test.test_date>=$from_date$ and test.test_date<=$to_date$ and patient.patient_id=test.patient_id','-1|from_date:-1|to_date:','Display information of H1N1 patients in a period input by user')
...
insert into Exported_DB.MAPPING_TABLE values ('cough','cough','visit','reason','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('fever','fever','visit','reason','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('stomach problem','stomach problem','visit','reason','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('sore throat','sore throat','visit','reason','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('heart problem','heart problem','visit','reason','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('backache','backache','visit','reason','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('respiratory problem','respiratory problem','visit','reason','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('cephalalgia','headache','visit','reason','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('MCHC','mean corpuscular hemoglobin concentration','test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('RDW','red cell distribution width','test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('H1N1','swine influenza','test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('heart rate','heart rate','test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('TIBC','total iron binding capacity','test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('ABG','arterial blood gas','test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('dengue','dengue','test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('MCV','mean corpuscular volume','test','test_name','PH1000001')
insert into Exported_DB.MAPPING_TABLE values ('MCH','mean corpuscular hemoglobin','test','test_name','PH1000001')
