...
public abstract class AbstractConfigDialog extends AbstractDialog implements
		ActionListener {
	 ...
	 */
	public AbstractConfigDialog(Frame gui, String title, boolean model,
			int height, int width, String port, String capacity) {
	...
	protected JPanel makeContentPane(String port, String capacity) {
		...
		textPane.setBorder(BorderFactory.createTitledBorder(null,
				LanguageLoader.getProperty("label.conf"),
