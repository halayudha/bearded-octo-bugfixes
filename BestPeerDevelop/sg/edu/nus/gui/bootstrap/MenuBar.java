...
public final class MenuBar extends JMenuBar implements ActionListener {
	...
	/* define menu items */
	private final String[] menuName = { LanguageLoader.getProperty("gui.file"),
	...
	private final String[][] itemName = {
			...
			{ LanguageLoader.getProperty("menu.createRole"),
					LanguageLoader.getProperty("menu.roleConfig"),
					LanguageLoader.getProperty("menu.createUser"),
					LanguageLoader.getProperty("menu.createPeer"),
					LanguageLoader.getProperty("menu.openlog"),
					LanguageLoader.getProperty("menu.savelog"),
					LanguageLoader.getProperty("menu.clear") },
			{ LanguageLoader.getProperty("menu.refresh"),
					LanguageLoader.getProperty("menu.speed"),
					LanguageLoader.getProperty("menu.high"),
					LanguageLoader.getProperty("menu.normal"),
					LanguageLoader.getProperty("menu.low") },
			{ LanguageLoader.getProperty("menu.feedback"),
					LanguageLoader.getProperty("menu.help"),
					LanguageLoader.getProperty("menu.about") } };
	...
	private final String[][] commands = {
			...
			{ "top" },
			{ "createRole", "roleConfig", "createUser", "createPeer", "open",
					"save", "clear" },
	...
	private void addMenus() {
		...
		statMenuItem = this.makeMenuItem(itemName[0][0], commands[0][0],
				keyStroke[0][0]);
		menu.add(statMenuItem);

		stopMenuItem = this.makeMenuItem(itemName[0][1], commands[0][1],
				keyStroke[0][1]);
		menu.add(stopMenuItem);
		menu.addSeparator();

		confMenuItem = this.makeMenuItem(itemName[0][2], commands[0][2],
				keyStroke[0][2]);
		menu.add(confMenuItem);
		menu.addSeparator();

		menuItem = this.makeMenuItem(itemName[0][3], commands[0][3],
				keyStroke[0][3]);
		menu.add(menuItem);
	...
	public void actionPerformed(ActionEvent event) {
		...
		/* if Open log file */
			...
			JOptionPane.showMessageDialog(bootstrapGUI, "Menu item: "
					+ commands[2][4]);
		}
		/* if save log file */
		...
		/* if send feedback */
			...
			new FeedbackDialog(bootstrapGUI, "Feedback & Error History", true,
					500, 400);
		}
		/* if open help topic */
