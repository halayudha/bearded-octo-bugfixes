...
public class PlasticTabbedPaneUI extends BasicTabbedPaneUI {
	...
	protected void paintTabBackground(Graphics g, int tabPlacement,
		...
		case LEFT:
			...
			gradientShadow = new GradientPaint(x, y, new Color(0, 0, 255), x, y
					+ h, Color.ORANGE);
			break;
		case RIGHT:
		...
		// Encima, pintamos la pestaña con el color que le corresponde por
		// profundidad
		if (runCount > 1) {
			g2D
					.setColor(hazAlfa(getRunForTab(tabPane.getTabCount(),
							tabIndex) - 1));
			g2D.fill(shape);
		}
