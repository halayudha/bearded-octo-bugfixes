...
public abstract class AbstractEventDialog extends AbstractDialog implements
		ActionListener {
	...
	protected String[] btnName = { "up", "down",
			LanguageLoader.getProperty("label.close") };
	 ...
	 */
	public AbstractEventDialog(Frame gui, String title, boolean model,
		...
		tabbedPane.add(LanguageLoader.getProperty("label.eventname"), this
				.makeContentPane());
