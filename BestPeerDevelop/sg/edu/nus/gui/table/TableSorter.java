...
public class TableSorter extends AbstractTableModel {
	...
	/**
	 * Compare two <code>Comparable</code> object. 
	 */
	...
	// private members
	private static final long serialVersionUID = -2647101746528202734L;
	 ...
	 * 
	 * @param tableModel the table model to be sorted
	 */
	 ...
	 * 
	 * @param tableModel the table model to be sorted
	 * @param tableHeader the table header to be displayed
	 */
	 ...
	 * 
	 * @param tableModel the table model to be assigned to the table sorter
	 */
	 ...
	 * 
	 * @return if at least one column is sorting, return <code>true</code>;
	...
	/**
	 * Get the sort information of the specified column.
	 * 
	 * @param column the column to be checked
	 * @return the sort information <code>Directive</code>
	 */
	...
	/**
	 * Get the arrow icon of the specified column.
	 * 
	...
	/**
	 * Clear the sort status of all columns.
	 */
	...
	/**
	 * Get the comparator in the specified column.
	 * 
	 * @param column the column to be checked
	 ...
	 * 
	 * @param viewIndex the index of the row to be sorted
	...
	private static class Directive {
		private int column; // the column to be sorted
		private int direction; // the sort type
