...
public abstract class AbstractRegisterDialog extends AbstractDialog implements
		ActionListener {
	 ...
	 */
	public AbstractRegisterDialog(Frame gui, String title, boolean model,
			int height, int width, String[] ip, String port) {
	...
	protected JPanel makeContentPane(String[] ip, String port) {
		...
		textPane.setBorder(BorderFactory.createTitledBorder(null,
				"Register User Account", TitledBorder.DEFAULT_JUSTIFICATION,
