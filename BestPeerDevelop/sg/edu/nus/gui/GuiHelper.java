...
public class GuiHelper {
	...
	public static Border createLnFBorder() {
		Border component = BorderFactory
				.createLineBorder(GuiLoader.componentBorderColor);
		return component;
	}
	...
	public static JPanel createBlankColorPanel(int height, int width,
			Color bkColor) {
		JPanel pane = new JPanel();
		pane
				.setBorder(new EmptyBorder(new Insets(height, width, height,
						width)));
	...
	public static JPanel createBlankThemePanel(int top, int left, int bottom,
			int right) {
		JPanel pane = new JPanel();
