...
public class DBManagerPanel extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5955425512653049119L;
	...
	public void setComponentText() {
		...
		dbExplorerLabel.setText(LanguageLoader
				.getProperty("dbmanager.dbexplorer"));
	}
	...
	private void initialize() {
		...
		this.dbConfigIcon_normal = new ImageIcon(
				"./sg/edu/nus/gui/res/dbconfigure_normal.gif");
		this.dbConfigIcon_selected = new ImageIcon(
				"./sg/edu/nus/gui/res/dbconfigure_selected.gif");

		this.dbConfigLabel = new JLabel(this.dbConfigIcon_normal);
		this.dbConfigLabel.setText(LanguageLoader
				.getProperty("dbmanager.dbconfig"));
		...
		this.dbConfigLabel.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				...
				DBManagerPanel.this.dbConfigLabel
						.setIcon(DBManagerPanel.this.dbConfigIcon_selected);
			...
			public void mouseExited(MouseEvent e) {
				...
				DBManagerPanel.this.dbConfigLabel
						.setIcon(DBManagerPanel.this.dbConfigIcon_normal);
			}

			public void mouseClicked(MouseEvent e) {

				DBConfigureView dbConfigView = new DBConfigureView(
						DBManagerPanel.this.parentComponent);
		...
		this.dbExplorerIcon_normal = new ImageIcon(
				"./sg/edu/nus/gui/res/dbexplorer_normal.png");
		this.dbExplorerIcon_selected = new ImageIcon(
				"./sg/edu/nus/gui/res/dbexplorer_selected.png");

		this.dbExplorerLabel = new JLabel(this.dbExplorerIcon_normal);
		this.dbExplorerLabel.setText(LanguageLoader
				.getProperty("dbmanager.dbexplorer"));
		...
		this.dbExplorerLabel.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				...
				DBManagerPanel.this.dbExplorerLabel
						.setIcon(DBManagerPanel.this.dbExplorerIcon_selected);
			...
			public void mouseExited(MouseEvent e) {
				...
				DBManagerPanel.this.dbExplorerLabel
						.setIcon(DBManagerPanel.this.dbExplorerIcon_normal);

			}

			public void mouseClicked(MouseEvent e) {
				DBExplorerPanel dbxPanel = new DBExplorerPanel(
						DBManagerPanel.this.parentComponent);
