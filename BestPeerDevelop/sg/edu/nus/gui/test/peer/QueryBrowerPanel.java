...
public class QueryBrowerPanel extends JPanel {
	 ...
	 */
	public QueryBrowerPanel(String userName) {
		super();
	...
	public void initialize() {
		 ...
		 */
		// this.iconExecution = new
		// ImageIcon("./sg/edu/nus/gui/res/executequery.gif");
		...
		this.btnExecution.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sqlCommand = QueryBrowerPanel.this.sqlInputArea
							.getText();
		...
		scrollTable.setPreferredSize(new Dimension(150, 400));
		...
		scrollTree.setPreferredSize(new Dimension(150, 400));
		...
		btnExecution.setBorder(new EmptyBorder(new Insets(100,10,100,10)));
