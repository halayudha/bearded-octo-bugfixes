...
public class OperatePanel extends JTabbedPane {
	...
	public static int TAB_ACCESSMANAGER_INDEX = 2;
	public static int TAB_QUERYMANAGER_INDEX = 3;
	 ...
	 */
	ImageIcon loginIcon = new ImageIcon("./sg/edu/nus/gui/res/peerlogin.png");
	...
	ImageIcon accessManagerIcon = new ImageIcon(
			"./sg/edu/nus/gui/res/accesscontrol.png");
	...
	public void setComponentText() {
		...
		this
				.setToolTipTextAt(1, LanguageLoader
						.getProperty("tab.dbmanagertip"));
		this.setToolTipTextAt(2, LanguageLoader
				.getProperty("tab.querymanagertip"));
		this.setToolTipTextAt(3, LanguageLoader
				.getProperty("tab.usermanagertip"));
	...
	private void initialize() {
		...
		panelAccessControl = new PanelAccessControlManagement(
				ServerPeer.conn_metabestpeerdb, servergui);
		...
		String querymanagerTitle = LanguageLoader
				.getProperty("tab.querymanager");
		String accessmanagerTitle = LanguageLoader
				.getProperty("tab.accessmanager");
		 ...
		 */
		this.addTab(lengthVec.get(0), this.loginIcon, loginPanel,
				LanguageLoader.getProperty("tab.logintip"));
		this.addTab(lengthVec.get(1), this.dbManagerIcon, dbManagerPanel,
				LanguageLoader.getProperty("tab.dbmanagertip"));
		
		this.addTab(lengthVec.get(3), this.accessManagerIcon,
				panelAccessControl, LanguageLoader
						.getProperty("tab.accessmanagertip"));
		...
		this.setUI(new BasicTabbedPaneUI() {
			public int calculateTabHeight(int tabPlacement, int tabIndex,
					int fontHeight) {
			...
			public int calculateTabWidth(int tabPlacement, int tabIndex,
					FontMetrics metrics) {
