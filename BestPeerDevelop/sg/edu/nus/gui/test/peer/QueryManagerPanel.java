...
public class QueryManagerPanel extends JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2022687152537853003L;
	...
	public void setComponentText() {
		sqlQueryLabel.setText(LanguageLoader
				.getProperty("querymanager.sqlquery"));
	}
	...
	private void initialize() {
		...
		this.sqlQueryIcon_normal = new ImageIcon(
				"./sg/edu/nus/gui/res/sql_query_normal.png");
		this.sqlQueryIcon_selected = new ImageIcon(
				"./sg/edu/nus/gui/res/sql_query_selected.png");

		this.sqlQueryLabel = new JLabel(this.sqlQueryIcon_normal);
		this.sqlQueryLabel.setText(LanguageLoader
				.getProperty("querymanager.sqlquery"));
		...
		this.sqlQueryLabel.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent e) {
				...
				QueryManagerPanel.this.sqlQueryLabel
						.setIcon(QueryManagerPanel.this.sqlQueryIcon_selected);
			...
			public void mouseExited(MouseEvent e) {
				...
				QueryManagerPanel.this.sqlQueryLabel
						.setIcon(QueryManagerPanel.this.sqlQueryIcon_normal);
			}

			public void mouseClicked(MouseEvent e) {
				sqlQueryBrowerPanel = new SQLQueryBrowerPanel(
						QueryManagerPanel.this.parentComponent);

				QueryManagerPanel.this.parentComponent.setComponentAt(
						OperatePanel.TAB_QUERYMANAGER_INDEX,
						sqlQueryBrowerPanel);
			}
		});
