...
public class LoginPanel extends JPanel implements ActionListener {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2111154407815776037L;
	...
	String[] userTypes = new String[] {
			LanguageLoader.getProperty("UserType.professional"),
			LanguageLoader.getProperty("UserType.normal") };

	String[] serverTypes = new String[] {
			LanguageLoader.getProperty("Login.bootstrapserver"),
	...
	public LoginPanel(OperatePanel parentComponent) {
		...
		this.jlDescription1 = new JLabel(LanguageLoader
				.getProperty("Login.firstdescription"));
		this.jlDescription2 = new JLabel(LanguageLoader
				.getProperty("Login.seconddescription"));

		this.jlBootstrapServer = new JLabel(serverTypes[0]);
		this.jcbBootstrapServer = new JComboBox(
		...
		this.jlPassword = new JLabel(LanguageLoader
				.getProperty("Login.password"));
		this.jtfPassword = new JPasswordField();
		this.jlUserType = new JLabel(LanguageLoader
				.getProperty("Login.usertype"));
		...
		this.btnLogin = new JButton(LanguageLoader
				.getProperty("Login.btnLogin"));
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (cmd.equals(strCmdUserType)) {
			jlBootstrapServer.setText(serverTypes[jcbUserType
					.getSelectedIndex()]);
		}
		/* if login */
	 ...
	 * enable the login button (after login failure or successful logout)
	 */
