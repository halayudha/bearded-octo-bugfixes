...
public class FeedbackDialog extends AbstractDialog implements ActionListener {
	...
	protected final String[] btnName = {
			LanguageLoader.getProperty("button.send"),
	...
	public FeedbackDialog(Frame gui, String title, boolean model, int height,
			int width) {
	...
	protected JPanel makeFeedbackPane() {
		...
		String[] subject = { LanguageLoader.getProperty("label.bug"),
				LanguageLoader.getProperty("label.feature"),
				LanguageLoader.getProperty("label.technical"),
				LanguageLoader.getProperty("label.suggest") };
	...
	protected JPanel makeHistoryPane() {
		...
		String[] header = { LanguageLoader.getProperty("table.reportdate"),
				LanguageLoader.getProperty("table.feedtype"),
				LanguageLoader.getProperty("table.reportname"),
				LanguageLoader.getProperty("table.desp"),
				LanguageLoader.getProperty("table.fix") };
