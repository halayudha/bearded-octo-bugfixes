...
import sg.edu.nus.gui.sharing.SDBExplorerPanel;
...
public class SharedDBConnectView extends JPanel {
	// private members
	 ...
	 */
	public SharedDBConnectView(Component/*DatabaseExplorer*/parent) {
	...
	private void initPane() {
		...
		dbNameTextField = new JTextField("mydatabase");

		JLabel usernameLabel = new JLabel("User Name");
		usernameTextField = new JTextField("root");

		JLabel pwLabel = new JLabel("Password:");
		pwField = new JPasswordField("0323");
		...
		connectButton = new JButton("DisplaySharedInfo");
			...
			public void actionPerformed(ActionEvent event) {
				...
				try {
					if (connectToDatabase(driver, url, port, dbName, username,
						...
						((SDBExplorerPanel) (SharedDBConnectView.this.parentComponent))
								.setConnection(con);
						((SDBExplorerPanel) (SharedDBConnectView.this.parentComponent)).dbTreeView
	...
	private JComboBox listDrivers() {
		...
		cb.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				String item = SharedDBConnectView.this.driverComboBox
				...
				if (item.equalsIgnoreCase("ODBC")) {
					...
					SharedDBConnectView.this.urlTextField.setEnabled(true);
					SharedDBConnectView.this.portTextField.setEnabled(true);
	 ...
	 */
	private boolean connectToDatabase(String driver, String url, String port,
