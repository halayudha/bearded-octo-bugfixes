...
public class DBTreeNode extends DefaultMutableTreeNode {
	...
	/**
	 * @param hasInsertIndex
	 *            the hasInsertIndex to set
	 */
	...
	/**
	 * To facilitate Schema Mapping Recommendation A score is appended at the
	 * end of the name of the node created by Bing Tian
	 */
	public void addScore(double score) {
		if (this.sourceSchemaName.indexOf(':') == -1)
			this.sourceSchemaName = this.sourceSchemaName + ": "
					+ Double.toString(score);
		else
			this.sourceSchemaName = this.sourceSchemaName.substring(0,
					this.sourceSchemaName.indexOf(':'))
					+ ": " + Double.toString(score);
	}
}
