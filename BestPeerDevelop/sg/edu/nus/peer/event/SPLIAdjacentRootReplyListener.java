...
public class SPLIAdjacentRootReplyListener extends ActionAdapter {
	...
	public void actionPerformed(PhysicalInfo dest, Message msg)
		...
		try {
			...
			SPLIAdjacentRootReplyBody body = (SPLIAdjacentRootReplyBody) msg
					.getBody();
			...
			if ((treeNode.getLeftAdjacentNode() != null)
				...
				TreeNode transferNode = serverpeer.getTreeNode(new LogicalInfo(
						1, 1));
				if (SPGeneralAction.checkRotationPull(transferNode)) {
					SPGeneralAction.doLeave(serverpeer, serverpeer
							.getPhysicalInfo(), transferNode);
				} else {
					SPGeneralAction.doFindReplacement(serverpeer, serverpeer
							.getPhysicalInfo(), transferNode);
				}
	...
	public boolean isConsumed(Message msg) throws EventHandleException {
		if (msg.getHead().getMsgType() == MsgType.SP_LI_ADJACENT_ROOT_REPLY
				.getValue())
			return true;
		return false;
	}
