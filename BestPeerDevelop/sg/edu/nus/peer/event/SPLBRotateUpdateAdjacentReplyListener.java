...
public class SPLBRotateUpdateAdjacentReplyListener extends ActionAdapter {
	...
	public void actionPerformed(PhysicalInfo dest, Message msg)
		...
		try {
			...
			SPLBRotateUpdateAdjacentReplyBody body = (SPLBRotateUpdateAdjacentReplyBody) msg
					.getBody();
			...
			throw new EventHandleException(
					"SP_LB_ROTATE_UPDATE_ADJACENT_REPLY operation failure", e);
		}
	}

	public boolean isConsumed(Message msg) throws EventHandleException {
		if (msg.getHead().getMsgType() == MsgType.SP_LB_ROTATE_UPDATE_ADJACENT_REPLY
				.getValue())
			return true;
		return false;
	}
