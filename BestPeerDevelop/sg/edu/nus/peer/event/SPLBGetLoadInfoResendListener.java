...
import sg.edu.nus.protocol.body.SPLBGetLoadInfoResendBody;
...
public class SPLBGetLoadInfoResendListener extends ActionAdapter {
	...
	public void actionPerformed(PhysicalInfo dest, Message msg)
		...
		try {
			...
			SPLBGetLoadInfoResendBody body = (SPLBGetLoadInfoResendBody) msg
					.getBody();
			...
			if (!direction) {
				tbody = new SPLBGetLoadInfoBody(serverpeer.getPhysicalInfo(),
			...
			throw new EventHandleException(
					"SP_LB_GET_LOAD_INFO_RESEND operation failure", e);
		}
	}

	public boolean isConsumed(Message msg) throws EventHandleException {
		if (msg.getHead().getMsgType() == MsgType.SP_LB_GET_LOAD_INFO_RESEND
				.getValue())
			return true;
		return false;
	}
