 ...
 * Both events occurs when a peer selects a super peer to join either the super
 * network or a super peer.
 * 
 * @author Xu Linhao
...
public class JoinListener extends ActionAdapter {
	...
	public void actionPerformed(PhysicalInfo dest, Message msg)
		...
		} else if (msg.getHead().getMsgType() == MsgType.JOIN_FAILURE
				.getValue()) {
			try {
				UserBody ub = (UserBody) msg.getBody();
				String user = ub.getUserID();
