		...
		try {
			...
			if (direction == SPLIAdjacentBody.FROM_LEFT_TO_RIGHT) {
				if ((treeNode.getLeftAdjacentNode() != null)
					...
					if (PeerMath.compareNodePosition(failedNodeLevel,
							failedNodeNumber, parentLevel, parentNumber)) {
