...
import sg.edu.nus.protocol.body.SPLBSplitDataResendBody;
...
public class SPLBSplitDataResendListener extends ActionAdapter {
	...
	public void actionPerformed(PhysicalInfo dest, Message msg)
		...
		try {
			...
			SPLBSplitDataResendBody body = (SPLBSplitDataResendBody) msg
					.getBody();
			...
			if (!direction) {
				tbody = new SPLBSplitDataBody(serverpeer.getPhysicalInfo(),
						treeNode.getLogicalInfo(), body.getDirection(), body
								.getMinValue(), body.getMaxValue(), body
								.getData(), treeNode.getRightAdjacentNode()
								.getLogicalInfo());
				...
				tbody = new SPLBSplitDataBody(serverpeer.getPhysicalInfo(),
						treeNode.getLogicalInfo(), body.getDirection(), body
								.getMinValue(), body.getMaxValue(), body
								.getData(), treeNode.getLeftAdjacentNode()
								.getLogicalInfo());
			...
			throw new EventHandleException(
					"SP_LB_SPLIT_DATA_RESEND operation failure", e);
		}
	}

	public boolean isConsumed(Message msg) throws EventHandleException {
		if (msg.getHead().getMsgType() == MsgType.SP_LB_SPLIT_DATA_RESEND
				.getValue())
			return true;
		return false;
	}
