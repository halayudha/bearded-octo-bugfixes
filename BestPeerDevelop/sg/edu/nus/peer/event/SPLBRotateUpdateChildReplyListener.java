...
public class SPLBRotateUpdateChildReplyListener extends ActionAdapter {
	...
	public SPLBRotateUpdateChildReplyListener(AbstractMainFrame gui) {
		super(gui);
	}
	...
	public void actionPerformed(PhysicalInfo dest, Message msg)
		...
		try {
			...
			SPLBRotateUpdateChildReplyBody body = (SPLBRotateUpdateChildReplyBody) msg
					.getBody();
			...
			throw new EventHandleException(
					"SP_LB_ROTATE_UPDATE_CHILD_REPLY operation failure", e);
		}
	}

	public boolean isConsumed(Message msg) throws EventHandleException {
		if (msg.getHead().getMsgType() == MsgType.SP_LB_ROTATE_UPDATE_CHILD_REPLY
				.getValue())
			return true;
		return false;
	}
