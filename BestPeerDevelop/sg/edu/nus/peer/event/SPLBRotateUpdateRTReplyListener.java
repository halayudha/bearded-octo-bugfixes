...
public class SPLBRotateUpdateRTReplyListener extends ActionAdapter {
	...
	public void actionPerformed(PhysicalInfo dest, Message msg)
		...
		try {
			...
			SPLBRotateUpdateRoutingTableReplyBody body = (SPLBRotateUpdateRoutingTableReplyBody) msg
					.getBody();
			...
			throw new EventHandleException(
					"SP_LB_ROTATE_UPDATE_ROUTING_TABLE_REPLY operation failure",
					e);
		}
	}

	public boolean isConsumed(Message msg) throws EventHandleException {
		if (msg.getHead().getMsgType() == MsgType.SP_LB_ROTATE_UPDATE_ROUTING_TABLE_REPLY
				.getValue())
			return true;
		return false;
	}
