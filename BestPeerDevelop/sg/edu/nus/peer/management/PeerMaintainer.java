...
public class PeerMaintainer {
	...
	private PeerMaintainer() {
		clientList = Collections.synchronizedMap(new HashMap<String, PeerInfo>(
				50));
		serverList = Collections.synchronizedMap(new HashMap<String, PeerInfo>(
				50));
	}
	...
	public boolean containsValue(PeerInfo info) {
		return (clientList.containsValue(info) || serverList
				.containsValue(info));
	}
