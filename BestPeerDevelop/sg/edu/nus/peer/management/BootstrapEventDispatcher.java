...
public class BootstrapEventDispatcher extends AbstractEventDispatcher {
	...
	public void registerActionListeners() {
		...
		this.addActionListener(new ERPBootstrapInsertTableIndexListener(gui));
		this.addActionListener(new ERPBootstrapDeleteTableIndexListener(gui));
		this.addActionListener(new TableIndexSearchBootstrapListener(gui));
