 ...
 * <code>{@link sg.edu.nus.protocol.MsgType#PONG}</code> or <code>{@link sg.edu.nus.protocol.MsgType#TROUBLESHOOT}</code>.
 * 
...
public class ServerPnPReceiver extends UDPReceiver {
	 ...
	 */
	public ServerPnPReceiver(AbstractMainFrame gui, DatagramSocket ds,
			int maxConn) throws SocketException {
	...
	public void setupHandlers() {
		...
		for (int i = 0; i < maxConn; i++) {
			...
			new Thread(handlers[i], i + "-th UDP handler of Server Peer")
					.start();
		}
	}
