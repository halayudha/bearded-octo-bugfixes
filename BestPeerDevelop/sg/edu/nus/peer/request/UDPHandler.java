...
public abstract class UDPHandler implements Runnable {
	 ...
	 */
	protected static List<DatagramPacket> pool = Collections.checkedList(
			new LinkedList<DatagramPacket>(), DatagramPacket.class);
	...
	public UDPHandler(DatagramSocket ds) {
		listeners = Collections.checkedList(new Vector<UDPListener>(),
				UDPListener.class);
