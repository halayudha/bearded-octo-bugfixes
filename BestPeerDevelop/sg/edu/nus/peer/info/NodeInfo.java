...
public abstract class NodeInfo implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -519770324761549261L;
	// private members
	...
	public NodeInfo(String serializeData) {
		...
		try {
			...
			e.printStackTrace();
			System.out.println("Incorrect serialize data at NodeInfo:"
					+ serializeData);
		}
	}
	...
	public String serialize() {
		return this.physicalInfo.serialize() + ","
				+ this.logicalInfo.serialize();
	}
