...
public class SPUpdateRoutingTableDirectlyBody extends Body implements
		Serializable {
	 ...
	 */
	public SPUpdateRoutingTableDirectlyBody(PhysicalInfo physicalSender,
	...
	public SPUpdateRoutingTableDirectlyBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at UpdateRoutingTableDirectly:"
							+ serializeData);
