...
public class SPSearchExactBody extends Body implements Serializable {
	 ...
	 */
	public SPSearchExactBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalRequester,
			LogicalInfo logicalRequester, IndexValue data,
	...
	public SPSearchExactBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at SearchExact:"
					+ serializeData);
