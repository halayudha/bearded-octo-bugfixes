...
public class SPLBRotateUpdateChildReplyBody extends Body implements
		Serializable {
	 ...
	 */
	public SPLBRotateUpdateChildReplyBody(PhysicalInfo physicalSender,
	...
	public SPLBRotateUpdateChildReplyBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at LBRotateUpdateChildReply:"
							+ serializeData);
