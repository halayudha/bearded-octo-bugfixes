...
public class SPLIAdjacentRootReplyBody extends Body implements Serializable {
	 ...
	 */
	public SPLIAdjacentRootReplyBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, AdjacentNodeInfo newAdjacent,
			BoundaryValue borderValue, boolean direction,
	...
	public SPLIAdjacentRootReplyBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at LIAdjacentRootReply:"
							+ serializeData);
