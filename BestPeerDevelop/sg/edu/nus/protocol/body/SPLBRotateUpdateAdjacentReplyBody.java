...
public class SPLBRotateUpdateAdjacentReplyBody extends Body implements
		Serializable {
	 ...
	 */
	public SPLBRotateUpdateAdjacentReplyBody(PhysicalInfo physicalSender,
	...
	public SPLBRotateUpdateAdjacentReplyBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at LBRotateUpdateAdjacentReply:"
							+ serializeData);
