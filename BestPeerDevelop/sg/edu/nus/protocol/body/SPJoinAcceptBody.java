...
public class SPJoinAcceptBody extends Body implements Serializable {
	...
	public SPJoinAcceptBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, LogicalInfo newNodePosition,
			AdjacentNodeInfo leftAdjacent, AdjacentNodeInfo rightAdjacent,
			ContentInfo content, int numOfExpectedRTReply, boolean isFake,
			boolean direction) {
	...
	public SPJoinAcceptBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at JoinAccept:"
					+ serializeData);
