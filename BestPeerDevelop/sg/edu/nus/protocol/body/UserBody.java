...
public class UserBody extends Body {
	 ...
	 */
	public UserBody(String userID, String password, String email, String ip,
	...
	public String toString() {
		...
		// String result =
		// "UserBody format:= userID:password:email:ip:port:type\r\n";
		// result += userID + delim + password + delim + email + delim + ip
		// + delim + port + delim + type;
		//
		// return result;
		return userID + delim + password + delim + email + delim + ip + delim
				+ port + delim + type;
	}
