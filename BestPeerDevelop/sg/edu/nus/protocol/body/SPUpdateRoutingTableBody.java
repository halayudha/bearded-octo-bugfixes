...
public class SPUpdateRoutingTableBody extends Body implements Serializable {
	 ...
	 */
	public SPUpdateRoutingTableBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, RoutingItemInfo nodeInfo,
	...
	public SPUpdateRoutingTableBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at UpdateRoutingTable:"
							+ serializeData);
