...
public class SPLeaveNotifyBody extends Body implements Serializable {
	...
	public SPLeaveNotifyBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalReplacer,
			int position, int index, LogicalInfo logicalDestination) {
	...
	public SPLeaveNotifyBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at LeaveNotify:"
					+ serializeData);
