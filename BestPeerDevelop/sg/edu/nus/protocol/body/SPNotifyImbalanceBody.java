...
public class SPNotifyImbalanceBody extends Body implements Serializable {
	 ...
	 */
	public SPNotifyImbalanceBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, LogicalInfo missingNode,
	...
	public SPNotifyImbalanceBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at NotifyImbalance:"
					+ serializeData);
