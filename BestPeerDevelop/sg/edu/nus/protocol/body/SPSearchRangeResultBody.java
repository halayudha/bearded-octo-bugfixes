...
public class SPSearchRangeResultBody extends Body implements Serializable {
	 ...
	 */
	public SPSearchRangeResultBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, Vector<IndexValue> result,
	...
	public SPSearchRangeResultBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at SearchExactResult:"
					+ serializeData);
	...
	public String getString() {
		...
		outMsg += ((IndexValue) this.result.get(this.result.size() - 1))
				.toString();
