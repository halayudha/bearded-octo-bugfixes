...
public class SPSearchExactBundleBody extends Body implements Serializable {
	 ...
	 */
	public SPSearchExactBundleBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalRequester,
			LogicalInfo logicalRequester, Vector<IndexValue> data,
	...
	public SPSearchExactBundleBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at SearchExactBundle:"
					+ serializeData);
