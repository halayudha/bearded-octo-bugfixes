...
public class SPSearchPairBody extends Body implements Serializable {
	 ...
	 */
	public SPSearchPairBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalRequester,
			LogicalInfo logicalRequester, IndexPair data,
	...
	public SPSearchPairBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at SearchPair:"
					+ serializeData);
