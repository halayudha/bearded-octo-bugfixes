...
public class SPJoinSplitDataBody extends Body implements Serializable {
	...
	public SPJoinSplitDataBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalNewNode,
			LogicalInfo logicalNewNode, int numberOfExpectedRTReply,
			RoutingTableInfo leftRT, RoutingTableInfo rightRT,
			RoutingItemInfo parentNodeInfo, ChildNodeInfo rightChildInfo,
	...
	public SPJoinSplitDataBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at JoinSplitData:"
					+ serializeData);
