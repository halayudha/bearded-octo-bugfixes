...
public class SPLeaveFindReplacementNodeBody extends Body implements
		Serializable {
	 ...
	 */
	public SPLeaveFindReplacementNodeBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalRequester,
			LogicalInfo logicalRequester, LogicalInfo logicalDestination) {
	...
	public SPLeaveFindReplacementNodeBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at LeaveFindReplacementNode:"
							+ serializeData);
