...
public class SPSearchRangeBody extends Body implements Serializable {
	...
	public SPSearchRangeBody(PhysicalInfo physicalSender,
			...
			LogicalInfo logicalRequester, IndexValue minValue,
			IndexValue maxValue, boolean canLeft, boolean canRight,
	...
	public SPSearchRangeBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at SearchRange:"
					+ serializeData);
