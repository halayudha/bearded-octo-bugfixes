...
public class SPLIAdjacentRootBody extends Body implements Serializable {
	 ...
	 */
	public SPLIAdjacentRootBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalRequester,
			LogicalInfo logicalRequester, boolean direction,
			LogicalInfo logicalFailedNode, LogicalInfo logicalDestination) {
	...
	public SPLIAdjacentRootBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at LIAdjacentRoot:"
					+ serializeData);
