...
public class SPLIUpdateParentBody extends Body implements Serializable {
	...
	* Construct the message body with speicified parameters.
	 ...
	 */
	public SPLIUpdateParentBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalParent,
	...
	public SPLIUpdateParentBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at SPLIUpdateParentBody:"
							+ serializeData);
