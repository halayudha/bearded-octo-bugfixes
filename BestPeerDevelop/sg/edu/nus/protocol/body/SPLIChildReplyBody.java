...
public class SPLIChildReplyBody extends Body implements Serializable {
	...
	* Construct the message body with speicified parameters.
	 ...
	 */
	public SPLIChildReplyBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, ChildNodeInfo leftChild,
			ChildNodeInfo rightChild, LogicalInfo logicalDestination) {
	...
	public SPLIChildReplyBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at SPLIChildReplyBody:"
							+ serializeData);
