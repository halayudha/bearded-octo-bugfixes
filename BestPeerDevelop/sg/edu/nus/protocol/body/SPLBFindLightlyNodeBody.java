...
public class SPLBFindLightlyNodeBody extends Body implements Serializable {
	...
	* Construct the message body with speicified parameters.
	...
	public SPLBFindLightlyNodeBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalOverloaded,
			LogicalInfo logicalOverloaded, int order, int nextIndex,
			boolean direction, int queryLoad, LogicalInfo logicalDestination) {
	...
	public SPLBFindLightlyNodeBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at LBFindLightlyNode:"
					+ serializeData);
