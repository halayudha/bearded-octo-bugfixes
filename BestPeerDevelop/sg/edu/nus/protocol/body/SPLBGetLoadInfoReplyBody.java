...
public class SPLBGetLoadInfoReplyBody extends Body implements Serializable {
	 ...
	 */
	public SPLBGetLoadInfoReplyBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, int numOfElement, int order,
	...
	public SPLBGetLoadInfoReplyBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at LBGetLoadInfoReply:"
							+ serializeData);
