...
public class SPJoinForcedForwardBody extends Body implements Serializable {
	...
	* node is forced to join as a left child
	 ...
	 */
	public SPJoinForcedForwardBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, PhysicalInfo physicalRequester,
			ContentInfo content, boolean direction,
	...
	public SPJoinForcedForwardBody(String serializeData) {
		...
		try {
			...
			System.out.println("Incorrect serialize data at JoinForcedForward:"
					+ serializeData);
