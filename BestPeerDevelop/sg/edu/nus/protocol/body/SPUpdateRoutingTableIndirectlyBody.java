...
public class SPUpdateRoutingTableIndirectlyBody extends Body implements
		Serializable {
	...
	public SPUpdateRoutingTableIndirectlyBody(PhysicalInfo physicalSender,
			LogicalInfo logicalSender, RoutingItemInfo infoSender,
			RoutingItemInfo infoChild, int index, boolean direction,
			boolean special, LogicalInfo logicalDestination) {
	...
	public SPUpdateRoutingTableIndirectlyBody(String serializeData) {
		...
		try {
			...
			System.out
					.println("Incorrect serialize data at UpdateRoutingTableIndirectly:"
							+ serializeData);
