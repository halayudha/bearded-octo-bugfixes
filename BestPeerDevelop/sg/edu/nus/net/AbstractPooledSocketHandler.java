...
public abstract class AbstractPooledSocketHandler implements Runnable,
		PooledSocketHandler {
	 ...
	 */
	protected static List<Socket> pool = Collections.checkedList(
			new LinkedList<Socket>(), Socket.class);
