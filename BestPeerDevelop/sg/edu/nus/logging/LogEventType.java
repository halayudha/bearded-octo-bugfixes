...
public enum LogEventType {
	...
	FATALERROR("Fatal Error"), ERROR("Error"), WARNING("Warning"), MESSAGE(
			"Message"), INCOMINGMSG("Receive Message"), OUTGOINGMSG(
			"Send Message"), PRE_EVENT("Pre Event"), POST_EVENT("Post Event");
