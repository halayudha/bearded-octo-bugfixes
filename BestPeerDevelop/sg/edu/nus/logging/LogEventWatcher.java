...
public interface LogEventWatcher {
	...
	/**
	 * Add a log event for displaying to users. The format of the log event is
	 * defined by <code>LogEvent</code>.
	 * 
	 * @param type
	 *            the event type
	 * @param desp
	 ...
	 * @param host
	 *            the host name who sends requests
	 * @param src
	 *            the IP address of the requester
	 * @param dest
	 *            the IP address of the receiver
	 */
	void log(String type, String desp);
}