...
public class PeerMath {
	 ...
	 */
	public static int getRoutingTableSize(int number, int level,
			boolean direction) {
		int size = 1;
		int step = 1;
		if (!direction) {
	 ...
	 *			otherwise, return <code>false</code>
	 */
	public static boolean checkAncesstor(int number, int level,
			boolean direction) {
	 ...
	 * 			otherwise, return <code>false</code>
	 */
	public static boolean checkNode(int level, int number, int leftmostLevel,
			int leftmostNumber, int rightmostLevel, int rightmostNumber) {
		int maxLevel = level;
	 ...
	 */
	public static String calculateNewPosition(String ip, int level, int number,
			boolean direction) {
		if (direction) {
	 ...
	 */
	public static String findPosition(String knowledge, int level, int number,
			int type) {
	 ...
	 * 			is added into the existing list separated by an underscore
	 */
	public static String addElementToList(String element, String list,
			boolean special) {
		if (list.equals(""))
			return element;
		else {
			if (!special) {
				...
				if (underscoreindex == -1) {
					...
					return list.substring(0, underscoreindex + 1)
							+ element
							+ "_"
							+ list
									.substring(underscoreindex + 1, list
											.length());
				}
			}
		}
	 ...
	 * 			otherwise, return <code>false</code>
	 */
	public static boolean checkNodesSameTree(int leftLevel, int leftNumber,
			int rightLevel, int rightNumber) {
	 ...
	 * 			otherwise, return <code>false</code>
	 */
	public static boolean compareNodePosition(int level1, int number1,
			int level2, int number2) {
	...
	public static int getNumberOfExpectedRTReply(boolean isLeftChild,
			boolean hasSibling, RoutingTableInfo leftRT,
